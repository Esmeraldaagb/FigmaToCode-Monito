...
export default function AdoptionCard() {
  return (
    <Card className="relative bg-[#003459] rounded-3xl overflow-hidden shadow-xl border-0 p-0 mx-20 my-20">
      <div className="grid lg:grid-cols-2 items-stretch min-h-[350px]">
        ...
        <div className="flex items-end justify-center bg-transparent relative">
          <Image
            ...
            width={400}
            height={350}
            className="object-contain h-[250px] w-auto -rotate-45"
            priority
          />
        </div>

        {/* Colonne droite : contenu centré, pas de rotation */}
        <div className="bg-[#FFB775] flex flex-col justify-center items-start px-10 py-12  h-full">
